...
## Screenshot
![Εικόνα Λειτουργίας](assets/image.png)
...
## Οδηγίες Χρήσης
1. Εκτελέστε το `ImageConvertToWebp.exe`.
2. Πατήστε το **Browse** για να επιλέξετε τον φάκελο με τις φωτογραφίες σας.
3. Πατήστε το **Browse** για να επιλέξετε τον φάκελο αποθήκευσης.
4. Πατήστε **Start** για να ξεκινήσει η διαδικασία.
